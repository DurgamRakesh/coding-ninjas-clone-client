...
import BoxCourse from "../BoxCourse.jsx";
import SlideContent from "../SlideContent.jsx";
import axios from "axios";
import DropdownCard from "../header/DropdownCard.jsx";
...
const SecondContainer = () => {
  ...
  const handleSubmitRequest = (e) => {
    ...
    let count = 0;
    if (!validate.Number.test(form.Number)) {
      errorMessage.Number = "Number Should be 10 digits";
    } else {
      count += 1;
      errorMessage.Number = "";
    }
    if (!validate.Name.test(form.FirstName)) {
      errorMessage.Name = "FirstName Should contain(5-12) characters";
    } else {
      count += 1;
      errorMessage.Name = "";
    }
    ...
    if (!validate.Email.test(form.Email)) {
      errorMessage.Email = "Email Should be Valid(eg: abc@gmail.com)";
    } else {
      count += 1;
      errorMessage.Email = "";
    }
    if (!validate.Year.test(form.Graduateyear)) {
      errorMessage.Graduateyear = "year from (1995-2023)";
    } else {
      count += 1;
      errorMessage.Graduateyear = "";
    }
    ...
    if (count == 4) {
      axios
        .post("https://coding-ninjas-clone-server.onrender.com/requestCall", form)
        .then((res) => {
    ...
    <div id="fourth-page-whole">
      ...
      <div className="big-Page-fourth-page1">
        ...
        >
          ...
          <button className="req-button">Request Callback</button>
        </form>
      </div>
      ...
      <div className="news-updates">
        ...
        {display1 && (
          <div className="backward" onClick={handleClickBackward}>
            <div>
            <img
              src="https://files.codingninjas.in/0000000000003581.png"
              width={20}
              alt="404 Error"
            />
            </div>
